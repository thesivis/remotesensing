...
#define p 1.15f /* densidade do ar umido	kg m-3*/
#define cp 1004.0f /* cp é o calor específico do ar à pressão constante	J Kg-1 K-1 */
...
#define k 0.41f  /* von Karman constant */
